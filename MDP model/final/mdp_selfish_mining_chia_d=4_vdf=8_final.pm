...
module selfish_mining_general_strategy
	...
	[] honest_mined=0 & c32=1 -> 
					...
					x*(1-x)/total : (honest_mined'=1) & (adv'=b1) & (honest'=1-b1) & (b1'=b2) & (b2'=1) & (b3'=0) &
								(c11'=c21) & (c12'=c22) & (c21'=c31) & (c22'=0) & (c31'=0) & (c32'=0) & (c41'=0) & (c42'=0) +
					
					x*1*x/total : (c11'=min(d,c21+1)) & (honest_mined'=0) & (adv'=b1) & (honest'=1-b1) & (b1'=b2) & (b2'=1) & (b3'=0) &
								(c12'=c22) & (c21'=c31) & (c22'=0) & (c31'=0) & (c32'=0) & (c41'=0) & (c42'=0) +
					
					x*1*x/total *min(c11,1) : (c12'=min(d,c22+1)) & (honest_mined'=0) & (adv'=b1) & (honest'=1-b1) & (b1'=b2) & (b2'=1) & (b3'=0) &
								(c11'=c21) & (c21'=c31) & (c22'=0) & (c31'=0) & (c32'=0) & (c41'=0) & (c42'=0) +
					
					x*1*x/total : (c21'=min(d,c31+1)) & (honest_mined'=0) & (adv'=b1) & (honest'=1-b1) & (b1'=b2) & (b2'=1) & (b3'=0) &
								(c11'=c21) & (c12'=c22) & (c22'=0) & (c31'=0) & (c32'=0) & (c41'=0) & (c42'=0) +
					
					x*1*x/total *min(c21,1) : (c22'=1) & (honest_mined'=0) & (adv'=b1) & (honest'=1-b1) & (b1'=b2) & (b2'=1) & (b3'=0) &
								(c11'=c21) & (c12'=c22) & (c21'=c31) & (c31'=0) & (c32'=0) & (c41'=0) & (c42'=0) +
					
					x*1*x/total : (c31'=1) & (honest_mined'=0) & (adv'=b1) & (honest'=1-b1) & (b1'=b2) & (b2'=1) & (b3'=0) &
								(c11'=c21) & (c12'=c22) & (c21'=c31) & (c22'=0) & (c32'=0) & (c41'=0) & (c42'=0) +
					
					x*1*x/total *min(c31,1) : (c32'=1) & (honest_mined'=0) & (adv'=b1) & (honest'=1-b1) & (b1'=b2) & (b2'=1) & (b3'=0) &
								(c11'=c21) & (c12'=c22) & (c21'=c31) & (c22'=0) & (c31'=0) & (c41'=0) & (c42'=0) +
					
					x*1*x/total : (c41'=1) & (honest_mined'=0) & (adv'=b1) & (honest'=1-b1) & (b1'=b2) & (b2'=1) & (b3'=0) &
								(c11'=c21) & (c12'=c22) & (c21'=c31) & (c22'=0) & (c31'=0) & (c32'=0) & (c42'=0) +
					
					x*1*x/total  *min(c41,1) : (c42'=1) & (honest_mined'=0) & (adv'=b1) & (honest'=1-b1) & (b1'=b2) & (b2'=1) & (b3'=0) &
								(c11'=c21) & (c12'=c22) & (c21'=c31) & (c22'=0) & (c31'=0) & (c32'=0) & (c41'=0);
