...
formula n = (2+min(c31+c32,1)+min(c41+c42,1)); // number of blocks adv mines on top of
...
module selfish_mining_general_strategy
	...
	[] act=1 & honest_mined=1 -> (act'=0) & (honest_mined'=0) & (adv'=b1) & (honest'=1-b1) & (b1'=b2) & (b2'=b3) & (b3'=0) &
			(c31'=c41) & (c32'=c42) & (c41'=0) & (c42'=0); //does not publish
