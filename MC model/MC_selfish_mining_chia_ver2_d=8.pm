...
const double y = 0.5;
// d+1 is the max lead the adv can have
const int d = 8;
...
formula n = (n0+n1+n2+n3+n4+n5+n6+n7);
formula total = (n*x+1);
...
module SelfishMiningChia
	...
	[] h=2 & c=0 -> (1-x)/total : (n0'=0) & (n1'=0) & (n2'=0) & (n3'=0) & (n4'=0) & (n5'=0) & (n6'=0) & (n7'=0) & (h'=0) & (adv'=2) & (honest'=0) +
			...
			n6*x/total : (n7'=min(w,n7+1)) & (h'=h+1-min(1,n7)) & (adv'=0) & (honest'=0) +
			n7*x/total : (n0'=n1) & (n1'=n2) & (n2'=n3) & (n3'=n4) & (n4'=n5) & (n5'=n6) & (n6'=n7) & (n7'=1) & (adv'=1) & (honest'=0); //TODO
